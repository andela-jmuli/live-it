...
class TestEndPoints(SuperTestCase):
    ...
    def test_creation_of_a_bucketlist(self):
        ...
        response = self.app.post("/api/v1/bucketlists/",data=self.bucketlist, content_type="application/json")
    ...
    def test_editing_a_bucketlist(self):
        ...
        response = self.app.put("/api/v1/bucketlists/1",data=self.bucketlist, content_type="application/json")
